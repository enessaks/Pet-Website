	...
	<section class="ftco-section bg-light ftco-no-pt intro">
			...
			<div class="row">
				<div class="col-md-12 py-5 text-center">
					<h3 class="appointment-heading">Evcil Hayvan Ekle</h3>
					<div class="appointment-wrap d-flex align-items-center">
						<form action="#" class="appointment-form ftco-animate">
							<div class="row">
								...
								<div class="col-md-3">
									<div class="form-group">
										<input type="text" class="form-control" placeholder="Cinsiyet">
									</div>
								</div>
								<div class="col-md-3">
									<div class="form-group">
										<div class="form-field">
											<div class="select-wrap">
												...
												<select name="" id="" class="form-control">
													<option value="">Kedi</option>
													<option value="">Köpek</option>
													<option value="">Kuş</option>
								...
								<div class="col-md-3">
									<div class="form-group">
										<input type="text" class="form-control" placeholder="Yaş">
									</div>
								</div>

								<div class="col-md-3">
									<div class="form-group">
										<input type="text" class="form-control" placeholder="Ağırlık">
									</div>
								</div>
								...
								<div class="col-md-3">
									<div class="form-group">
										<input type="submit" value="Kaydet" class="btn btn-secondary py-3 px-4">
									</div>
								</div>
							</div>
						</form>

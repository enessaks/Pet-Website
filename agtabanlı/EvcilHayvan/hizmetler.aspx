	...
	<section class="ftco-section bg-light ftco-no-pt intro">
			...
			<div class="row">
			    ...
			    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" EmptyDataText="There are no data records to display." Width="600px">
                    <Columns>
                        <asp:BoundField DataField="hizmetler" HeaderText="hizmetler" SortExpression="hizmetler" />
                    </Columns>
                </asp:GridView>
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:evcil_hayvanConnectionString1 %>" ProviderName="<%$ ConnectionStrings:evcil_hayvanConnectionString1.ProviderName %>" SelectCommand="SELECT [hizmetler] FROM [sayfalar]"></asp:SqlDataSource>
			</div>
		</div>
	</section>
